...
for iteration in range(num_iterations):
    ...
    gene_conversion_tracts = sim_tracts(N, min(filtered_positions), max(filtered_positions), "geom2")
...
with open('sim_tracts_vcf_geom2_multiple_iterations.csv', 'w', newline='') as file:
