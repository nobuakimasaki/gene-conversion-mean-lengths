...
sim_tracts <- function(N_gene_conv, phi, length_chrom, dist_N) {
...
calc_neg_log_lik <- function(phi, psi_lst, pL, l_lst, M = FALSE) {
  if (M == FALSE) {
...
calculate_psi <- function(observed, psi, region, length_chrom, debias) {
