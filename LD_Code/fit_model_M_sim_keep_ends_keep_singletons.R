...
res.0.5.1M <- pmap(list(MAF.df.list, tracts.df.list.0.5, rep(1500, 20), rep(5000, 20), rep(0.5, 20)), fit_model_M, FALSE)
saveRDS(res.0.5.1M, "res.sim.M.1500.region.5000.geom.ibdclust2cM.MAF.0.5.boot.keep.ends.rds")
